...
## Keyword do cenário Receber novo pedido
...
E que "${produto}" está cadastrado no meu dashboard
    ...
    ${image_file}=   Get Binary File         ${EXECDIR}/resources/images/produto.jpeg
...
Quando o cliente solicita o preparo desse prato
    ...
    Sleep				2   #Temporario (não é uma boa prática)
...
E posso aceitar ou rejeitar esse pedido
    Wait Until Page Contains        ACEITAR         5   #TEM ATÉ 5 SEGUNDOS PARA ENCONTRAR O ELEMENTO
